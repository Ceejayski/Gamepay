    ...
    <aside className="text-right">
      <div>
        <div className="category">
          <p className="cat-title mb-1">Browse Categories</p>
        ...
        <div className="category mt-4">
          <p className="cat-title mb-1"> Genres</p>

          <div className="cat-item-list ms-3">
            {
              genres.map((genre) => (
                <div key={genre.name} className="cat-item d-flex align-items-center mb-2">
                  <div className="cat-item-icon">
        ...
        <div className="category mt-4">
          <p className="cat-title mb-1"> Recently Viewed</p>
        </div>
      </div>
    </aside>
  );
